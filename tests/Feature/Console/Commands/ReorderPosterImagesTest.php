...
it('skips clip with no assets', function () {
    ...
    $this->artisan('clip:posterImage')->expectsOutputToContain("Assets not found for Clip ID {$clip->id}! Skipping...");
});
...
it('updated clip poster path', function () {
    ...
    $this->artisan('clip:posterImage')->expectsOutputToContain("Finish clip ID {$series->clips->first()->id}");
